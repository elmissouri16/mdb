...
class TvShows extends Mdb {
	async searchTvShow({ query, page, first_air_date_year, language }) {
		if (!query || query === '') {
	...
	async getTvShowDetails({ tv_id, language }) {
		if (!tv_id || tv_id === '') {
	...
	async getTvShowRecomndations({ tv_id, page, language }) {
		if (!tv_id || tv_id === '') {
			throw new Error('tv_id is required!');
		}
	...
	async geSimilartTvShows({ tv_id, page, language }) {
		if (!tv_id || tv_id === '') {
			throw new Error('tv_id is required!');
		}
	...
	async geTvShowVideos({ tv_id, language }) {
		if (!tv_id || tv_id === '') {
			throw new Error('tv_id is required!');
		}
	...
	async getEpisodeGroups({ tv_id, language }) {
		if (!tv_id || tv_id === '') {
			throw new Error('tv_id is required!');
		}
	...
	async getTvshowSeason({ tv_id, season_number, language }) {
		if (!tv_id || tv_id === '') {
			throw new Error('tv_id is required!');
		}
