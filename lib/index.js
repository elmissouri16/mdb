...
class Movies extends Mdb {
	...
	async getMovieDetails({ movie_id }) {
		...
		return pv
			.get(this)
			.request(`/movie/${movie_id}`, { qs: { api_key: this.ApiKey }, body: '{}' })
			.then(data => {
				return data;
			})
			.catch(err => {
	...
	async getMovieVideos({ movie_id }) {
		...
		return pv
			.get(this)
			.request(`/movie/${movie_id}/videos`, { qs: { api_key: this.ApiKey }, body: '{}' })
			.then(data => {
				return data;
			})
			.catch(err => {
	...
	async getSimilarMovies({ movie_id, page }) {
		...
		return pv
			.get(this)
			.request(`/movie/${movie_id}/similar`, { qs: { api_key: this.ApiKey, page: page }, body: '{}' })
			.then(data => {
				return data;
			})
			.catch(err => {
	...
	async getRecommendedMovies({ movie_id, page }) {
		...
		return pv
			.get(this)
			.request(`/movie/${movie_id}/recommendations`, {
				qs: {
					api_key: this.ApiKey,
					page: page,
				},
	...
	async getMovieReviews({ movie_id, page }) {
		...
		return pv
			.get(this)
			.request(`/movie/${movie_id}/reviews`, {
				qs: {
					api_key: this.ApiKey,
					page: page,
				},
...
class TvShows extends Mdb {
	...
	async getTvShowRecomndations({ tv_id, page }) {
		return pv
			.get(this)
			.request(`/tv/${tv_id}/recommendations`, {
				qs: {
					tv_id: tv_id,
					page: page,
					api_key: pv.get(this).ApiKey,
	...
	async getEpisodeGroups({ tv_id }) {
		return pv
			.get(this)
			.request(`/tv/${tv_id}/episode_groups`, {
				qs: {
					tv_id: tv_id,
					api_key: pv.get(this).ApiKey,
				},
